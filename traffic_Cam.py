...
# LOAD TRAIN MODEL
my_model = tf.keras.models.load_model('model_camera.h5')
my_model.load_weights('weights_camera.h5')
...
def getClassName(classNo):
    ...
    elif classNo == 42:return 'End no passing vehicles > 3.5'
...
while True:
    ...
    if probabilityValue > threshold:
        ...
        cv2.putText(imgOrignal, str(classIndex)+" "+str(getClassName(classIndex)), (185, 35), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
        cv2.putText(imgOrignal, str(round(probabilityValue*100, 2))+"%", (185, 75), font, 0.75, (0, 255, 0), 2, cv2.LINE_AA)
